...
function AcompanhamentoIcismap() {
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1Yp1XDUm3idRP1K7WDdhx3Id_hhTOPGgT101wu4zrZVA/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default AcompanhamentoIcismap;
