...
function ConsorciosPrevisao() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("ConsorciosPrevisao")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/13lz7KXbQtMS0_zyUyhgY0oIdaIEuaV7W/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default ConsorciosPrevisao;
