...
function ControleEntradasSaidas2024Import() {
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/16-pFLbpqm9kwlPmmoxHIKDHM49IVBrQXlBpTWs9uqUM/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default ControleEntradasSaidas2024Import;
