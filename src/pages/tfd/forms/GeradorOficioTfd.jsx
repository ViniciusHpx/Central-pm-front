...
function GeradorOficioTfd() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("GeradorOficioTfd")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/forms/d/e/1FAIpQLSf2pnddS_rZGrItN6ApO9_vWV55gzf5QTI7kciqE377fG7mIw/viewform"
                    ></iframe>
                </div>
            )}
        </div>
...
export default GeradorOficioTfd;
