...
function ControleEntradasSaidas20242SForms() {
            ...
            .then((res) => {
                if (
                    !res.data.permissoes.includes(
                        "ControleEntradasSaidas20242SForms"
                    )
                ) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/forms/d/e/1FAIpQLSd6crxH70F6FpSKp4EtEtXoTdaxj73h8WlPxinRTy7PwkmGeg/viewform"
                    ></iframe>
                </div>
            )}
        </div>
...
export default ControleEntradasSaidas20242SForms;
