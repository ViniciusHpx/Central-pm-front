...
function GeradorMemorandoTfd() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("GeradorMemorandoTfd")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/forms/d/e/1FAIpQLSfsHk37VSNsgFcJX6ezEo0VTTgJnkYw67DTQj7fSie3qn8VnA/viewform"
                    ></iframe>
                </div>
            )}
        </div>
...
export default GeradorMemorandoTfd;
