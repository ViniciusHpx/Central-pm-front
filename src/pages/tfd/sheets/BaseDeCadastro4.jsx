...
function BaseDeCadastro4() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("BaseDeCadastro4")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1jQECU5jNk4gBsrccasT9QAY89a0on1brmI9sDM6-654/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default BaseDeCadastro4;
