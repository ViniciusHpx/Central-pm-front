...
function ControleEntradasSaidas20242S() {
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1QCGmEoVulWmG1lTLHCuhTG21dCVVqcTUGMRewIkU3nk/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default ControleEntradasSaidas20242S;
