...
function ControleEntradasSaidas20241S() {
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1UQH3bbLQsiDYJld2b9-v-xLnoy5gG0dpV-A_NDsE-e8/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default ControleEntradasSaidas20241S;
