...
function BaseDeCadastro5() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("BaseDeCadastro5")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/18xYRrmaRiAsJ_0w4X3Xuunum2XoUcw8eJZam2w3iHLM/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default BaseDeCadastro5;
