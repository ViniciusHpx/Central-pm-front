...
function BaseDeCadastro2() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("BaseDeCadastro2")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1kUblUCTfT-ppJuf1Q6H9b6sb39AwmDaF8V8UHBtfDe0/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default BaseDeCadastro2;
