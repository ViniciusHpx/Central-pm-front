...
function BaseDeCadastro3() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("BaseDeCadastro3")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/17ILSQxxilRuRigkwPxny6jqbnfIzMO3G-mAdb5iiHaA/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default BaseDeCadastro3;
