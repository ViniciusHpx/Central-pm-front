...
function DemandaCatarata() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("DemandaCatarata")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1Zmpo-AW-fEJDFJ161N4oFoZXpccTsDVClYxinlFjfiY/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default DemandaCatarata;
