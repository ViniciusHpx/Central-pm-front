...
function AcompanhamentoPacientesHiperdia() {
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1MxOObL4impOkf_KoJKDaWRIbcZ3RV8Mi6-gbUKWxuwo/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default AcompanhamentoPacientesHiperdia;
