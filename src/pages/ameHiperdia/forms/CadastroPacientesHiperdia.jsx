...
function CadastroPacientesHiperdia() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (
                    !res.data.permissoes.includes("CadastroPacientesHiperdia")
                ) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/forms/d/e/1FAIpQLSdWVdIvqbq_5ug3Sz2kUHUZ3jCVNA0Swncbz1Z9iFwczSmCcg/viewform"
                    ></iframe>
                </div>
            )}
        </div>
...
export default CadastroPacientesHiperdia;
