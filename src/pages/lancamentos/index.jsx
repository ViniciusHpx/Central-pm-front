...
function CarteiraServicos() {
    var token = window.localStorage.getItem("x-access-token");
    const navigate = useNavigate();

    const [loading, setLoading] = useState(false);
    const [openAddLancamentos, setOpenAddProtocolo] = useState(false);
    const [titulo, setTitulo] = useState("");
    const [link, setLink] = useState("");
    const [lancamentos, setProtocolos] = useState([]);
    ...
    async function handleAdicionar() {
        ...
        await axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("lancamentos")) {
                    navigate("/");
                    return Swal.fire("Acesso negado", "", "error");
                }
                axios({
                    method: "post",
                    url: "https://central-pm-api-dev.onrender.com/lancamentos/",
                    data: {
                        titulo: titulo,
                        link: link,
                    },
    ...
    function handleDeletar(id) {
        ...
        if (confirmacao) {
            axios({
                method: "delete",
                url: `https://central-pm-api-dev.onrender.com/lancamentos/${id}`,
                headers: {
                    authorization: token,
                },
            })
    ...
    return (
        <div>
            <SideNav activeLink={"lancamentos"} />
            <div
