...
function ConsolidadoAssistencia() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("ConsolidadoAssistencia")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://lookerstudio.google.com/embed/reporting/b8fb9f14-f76e-47ea-a572-3053673c4c57/page/GIUjD"
                    ></iframe>
                </div>
            )}
        </div>
...
export default ConsolidadoAssistencia;
