...
function CadastroDePacientesAssistenciaSaudeForm() {
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/forms/d/e/1FAIpQLSe8tWk3uAVOON5WG8iYaZcQBBzUagvNj8DQTDs47AAODAnT9w/viewform"
                    ></iframe>
                </div>
            )}
        </div>
...
export default CadastroDePacientesAssistenciaSaudeForm;
