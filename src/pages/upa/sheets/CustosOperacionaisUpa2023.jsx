...
function CustosOperacionaisUpa2023() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (
                    !res.data.permissoes.includes("CustosOperacionaisUpa2023")
                ) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1_niMSJEA2bpx3YoZxJlGaATizhOF1lsp4K_nyLLxFLY/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default CustosOperacionaisUpa2023;
