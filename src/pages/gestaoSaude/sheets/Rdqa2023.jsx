...
function RdqaGestaoSaude2023() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("RdqaGestaoSaude2023")) {
                    navigate("/");
    ...
    return (
        <div>
            <SideNav activeLink={"gestaosaude"} />
            {loading ? (
                <div>
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1S_6bPlU62LZ-umJ5q0NmnNoUYNrh9M4v6nAh5wAtyfU/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default RdqaGestaoSaude2023;
