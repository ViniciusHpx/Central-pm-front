...
function RdqaControleSocial2023() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("RdqaControleSocial2023")) {
                    navigate("/");
    ...
    return (
        <div>
            <SideNav activeLink={"controlesocial"} />
            {loading ? (
                <div>
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1mF9vrq-FOrXJ3O7Pz3CAIp6ajXpXWCKOmDI7y7EAjMY/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default RdqaControleSocial2023;
