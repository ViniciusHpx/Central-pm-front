...
function AcompanhamentoDosProcessos() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (
                    !res.data.permissoes.includes("AcompanhamentoDosProcessos")
                ) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1JhgUrZj4t2QzRr5wKwsyO-CaR1hB-_w9_dUMAo9S1xo/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default AcompanhamentoDosProcessos;
