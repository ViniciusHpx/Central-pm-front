...
function UpaMateriaisAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("UpaMateriaisAlmox")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1CFdgo5zXMB4BI2Frr0BBKCPjUVm3Idkw-QW5FGrdhjM/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default UpaMateriaisAlmox;
