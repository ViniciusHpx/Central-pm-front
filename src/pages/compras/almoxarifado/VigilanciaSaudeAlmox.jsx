...
function VigilanciaSaude() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("VigilanciaSaude")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1LXlLMD_aF1NDDftdOQv8_iBGI993ecovO2iMd944Ffo/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default VigilanciaSaude;
