...
function CapsAdEventosAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("CapsAdEventosAlmox")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1w33SWQ4xqKoFlmqI4uBlJalCNP2j_4UZX8Ux0IL8A7I/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default CapsAdEventosAlmox;
