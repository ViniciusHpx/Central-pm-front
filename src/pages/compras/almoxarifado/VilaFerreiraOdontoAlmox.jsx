...
function VilaFerreiraOdontoAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("VilaFerreiraOdontoAlmox")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1cBzeL_paFh8pK_wTCmzH1Ko926t-r9YdLCEaTlYPqCo/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default VilaFerreiraOdontoAlmox;
