...
function PromocaoSaudeEventosAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (
                    !res.data.permissoes.includes("PromocaoSaudeEventosAlmox")
                ) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1_qBLE7yLvxdERCL3EtgUuhuNGMVzo4nXdPpx0pJbimQ/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default PromocaoSaudeEventosAlmox;
