...
function CaicOdontoAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("CaicOdontoAlmox")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1BVlQJdy5sl-HsQNGjDtN4I13RN97GDx4SJw75w1WXNU/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default CaicOdontoAlmox;
