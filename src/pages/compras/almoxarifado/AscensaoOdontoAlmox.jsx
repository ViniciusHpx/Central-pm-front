...
function AscensaoOdontoAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("AscensaoOdontoAlmox")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1gZMm4CFDD-cVzvXdiltCESAJZcipkItSevIhzxSn_hY/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default AscensaoOdontoAlmox;
