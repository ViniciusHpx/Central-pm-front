...
function UpaMedicamentosAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("UpaMedicamentosAlmox")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1DN1Y5U8hxS_xHIUidi4Vij-K0yRbeC-t_kOARkm0fbM/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default UpaMedicamentosAlmox;
