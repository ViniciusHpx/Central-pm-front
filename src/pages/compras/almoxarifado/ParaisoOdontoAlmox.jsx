...
function ParaisoOdontoAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("ParaisoOdontoAlmox")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/14orSc0wxMhOV2giZ1W3aVnmxFO5nWArBmWzFtriVWM0/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default ParaisoOdontoAlmox;
