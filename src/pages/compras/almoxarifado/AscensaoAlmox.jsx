...
function AscensaoAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("AscensaoAlmox")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1MTok-xr41zvECZHb8PFD91eqquSpVSp1-mHYd_lDc9M/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
