...
function DomboscoOdontoAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("DomboscoOdontoAlmox")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1bV-f_ZP-KIdCNGldFR1Q5lT09zyHBjDWGXut6fHwZrM/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default DomboscoOdontoAlmox;
