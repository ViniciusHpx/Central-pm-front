...
function AlmoxarifadoCentralAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("AlmoxarifadoCentralAlmox")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/11IBtIo0iLq8InaAMUcdP6jJUSW4Ctgb-zKywbFPwi_0/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default AlmoxarifadoCentralAlmox;
