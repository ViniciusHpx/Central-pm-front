...
function PovoadoMeirelesAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("PovoadoMeirelesAlmox")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1pmCD23sVPGQhB-w5uEC_SWMpQPHxvXpYu7jVc8BjHBo/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default PovoadoMeirelesAlmox;
