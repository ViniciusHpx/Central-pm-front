...
function AltoSantosDumontOdontoAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (
                    !res.data.permissoes.includes("AltoSantosDumontOdontoAlmox")
                ) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1p1DngaroiBGue_k-A-R-pLvLokPs7AEK2ZBLSN2G3ss/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default AltoSantosDumontOdontoAlmox;
