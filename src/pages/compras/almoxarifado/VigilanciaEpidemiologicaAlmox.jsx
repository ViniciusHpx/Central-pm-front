...
function VigilanciaEpidemiologicaAlmox() {
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1f4KUb9I4bskR5aPrscGByJlgqSXuL8K3RcR_tIOxQXs/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default VigilanciaEpidemiologicaAlmox;
