...
function TorneirosOdontoAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("TorneirosOdontoAlmox")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1rbFJUDltFEzRsxJJOo3a9Iu2CdGirIQWO6F1cp7o8yA/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default TorneirosOdontoAlmox;
