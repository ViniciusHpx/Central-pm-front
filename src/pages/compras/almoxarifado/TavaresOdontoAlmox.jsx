...
function TavaresOdontoAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("TavaresOdontoAlmox")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1kYt7dIyvYeRjG0vMgeb666Sk67GUtp1365SXb99Yt3I/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default TavaresOdontoAlmox;
