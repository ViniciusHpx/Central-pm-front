...
function RecantoOdontoAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("RecantoOdontoAlmox")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1jXJJAPzORIKTWrsV7sRkeOYdEjq6q_RiXsCR3kipgxE/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default RecantoOdontoAlmox;
