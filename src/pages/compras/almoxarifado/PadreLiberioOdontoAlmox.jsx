...
function PadreLiberioOdontoAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("PadreLiberioOdontoAlmox")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1_owqSJTrg-PXdMoM0Y6JsX8KupU0E0mK5-81WC7SZNQ/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default PadreLiberioOdontoAlmox;
