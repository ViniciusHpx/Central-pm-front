...
function NSFatimaOdontoAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("NSFatimaOdontoAlmox")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/15_98bTjnzJEItpLOCcLiP1at2tSs9QTRnk1qZ3x9Ki4/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default NSFatimaOdontoAlmox;
