...
function PadreLiberioAlmox() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("PadreLiberioAlmox")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1NZbwhOL5uxyEsHEryx8lhTNd9R4_ZHz3f6KeMWiG7U8/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default PadreLiberioAlmox;
