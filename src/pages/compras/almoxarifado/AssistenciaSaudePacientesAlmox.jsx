...
function AssistenciaSaudePacientesAlmox() {
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1yyeVF6FED2aIPXDv51psmDIn4ScgEg8qqszVp82Muhw/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default AssistenciaSaudePacientesAlmox;
