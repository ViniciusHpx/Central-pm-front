...
function Rag2022() {
    ...
    const [openAddRag2022, setOpenAddProtocolo] = useState(false);
    const [titulo, setTitulo] = useState("");
    const [link, setLink] = useState("");
    const [rag2022, setProtocolos] = useState([]);
    ...
    async function handleAdicionar() {
        ...
        await axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("Rag2022")) {
                    navigate("/");
                    return Swal.fire("Acesso negado", "", "error");
                }
                axios({
                    method: "post",
                    url: "https://central-pm-api-dev.onrender.com/rag2022/",
                    data: {
                        titulo: titulo,
                        link: link,
                    },
        ...
        if (confirmacao) {
            axios({
                ...
                .then((res) => {
                    ...
                    axios({
                        method: "delete",
                        url: `https://central-pm-api-dev.onrender.com/rag2022/${id}`,
                        headers: {
                            authorization: token,
                        },
                    })
