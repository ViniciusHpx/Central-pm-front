...
function Rag2023() {
    ...
    const [openAddRag2023, setOpenAddProtocolo] = useState(false);
    const [titulo, setTitulo] = useState("");
    const [link, setLink] = useState("");
    const [rag2023, setProtocolos] = useState([]);
    ...
    async function handleAdicionar() {
        ...
        await axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("Rag2023")) {
                    navigate("/");
                    return Swal.fire("Acesso negado", "", "error");
                }
                axios({
                    method: "post",
                    url: "https://central-pm-api-dev.onrender.com/rag2023/",
                    data: {
                        titulo: titulo,
                        link: link,
                    },
        ...
        if (confirmacao) {
            axios({
                ...
                .then((res) => {
                    ...
                    axios({
                        method: "delete",
                        url: `https://central-pm-api-dev.onrender.com/rag2023/${id}`,
                        headers: {
                            authorization: token,
                        },
                    })
