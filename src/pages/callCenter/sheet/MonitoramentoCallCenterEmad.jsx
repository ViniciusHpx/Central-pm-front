...
function MonitoramentoCallCenterEmad() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (
                    !res.data.permissoes.includes("MonitoramentoCallCenterEmad")
                ) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1vguB5Us5zDdggfPdq5ThzczUAWm0ZEtxhCCqyNRjRbg/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default MonitoramentoCallCenterEmad;
