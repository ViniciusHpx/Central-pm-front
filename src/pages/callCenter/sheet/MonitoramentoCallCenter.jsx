...
function MonitoramentoCallCenter() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("MonitoramentoCallCenter")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1c9tarZIxAoQ2gNzexjU8sTPAX1o9_0FHIwnHdY7UR4c/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default MonitoramentoCallCenter;
