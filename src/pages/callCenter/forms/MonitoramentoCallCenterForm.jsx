...
function MonitoramentoCallCenterForm() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (
                    !res.data.permissoes.includes("MonitoramentoCallCenterForm")
                ) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/forms/d/17iBzhrjYdfcHVi5YhgwxhJbNfvNcuPazBp3FSdxSNZ0/viewform?embedded=true"
                    ></iframe>
                </div>
            )}
        </div>
...
export default MonitoramentoCallCenterForm;
