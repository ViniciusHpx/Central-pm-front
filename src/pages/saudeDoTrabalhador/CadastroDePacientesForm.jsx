...
function CadastroDePacientesForm() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("CadastroDePacientesForm")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/forms/d/e/1FAIpQLScNHe5ZDZSA-pYm0OG-08-HY_coU5IF2Dr21kv1QVoc6Qbbxg/viewform?usp=sharing"
                    ></iframe>
                </div>
            )}
        </div>
...
export default CadastroDePacientesForm;
