...
function ControleDeAtestadosImport() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (
                    !res.data.permissoes.includes("ControleDeAtestadosImport")
                ) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1hescq0i-8hsTtol9XxhmNkAnZ4cI0y70TftmmlwT2LY/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default ControleDeAtestadosImport;
