...
function CadastroDePacientesDb() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("CadastroDePacientesDb")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1cGYTuRSD1I73dgLLCDWT6ky71h5UCwtfQBPhkzI0pwk/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default CadastroDePacientesDb;
