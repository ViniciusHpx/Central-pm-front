...
function ControleDeAtestadosBD2023() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (
                    !res.data.permissoes.includes("ControleDeAtestadosBD2023")
                ) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1OKGb4zw-C564p3UoqXT7GrN7c10k3uRY2nkDsW2yVxQ/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default ControleDeAtestadosBD2023;
