...
function ControleDeAtestadosBD() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("ControleDeAtestadosBD")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1vl7Qb0cqBlbz8VXAFeuhtbYyHqQVim2A9VVXVLhs5eo/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default ControleDeAtestadosBD;
