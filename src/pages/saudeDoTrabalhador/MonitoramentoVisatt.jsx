...
function MonitoramentoVisatt() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("MonitoramentoVisatt")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1PUS44CmCmsB3gxWtowkY2DuKZDjv0Yj2Drfg6P8IhP8/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default MonitoramentoVisatt;
