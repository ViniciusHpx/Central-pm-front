...
function ConsolidadoNotificacoesBi() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (
                    !res.data.permissoes.includes("ConsolidadoNotificacoesBi")
                ) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://datastudio.google.com/embed/reporting/a693e939-f80a-44c0-9ba9-53e17fc5c0bb/page/p_fgh0q97zlc/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default ConsolidadoNotificacoesBi;
