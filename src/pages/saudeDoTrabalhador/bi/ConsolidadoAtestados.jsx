...
function ConsolidadoAtestados() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("ConsolidadoAtestados")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://datastudio.google.com/embed/reporting/6976cee1-5864-4531-8d70-7ac22e9bffb6/page/p_j4uws9w8zc/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default ConsolidadoAtestados;
