...
function MonitoramentoSaudeTrabalhador() {
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://datastudio.google.com/embed/reporting/cac30f84-41e6-43ad-af64-2f43c6f212c5/page/zcWxC/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default MonitoramentoSaudeTrabalhador;
