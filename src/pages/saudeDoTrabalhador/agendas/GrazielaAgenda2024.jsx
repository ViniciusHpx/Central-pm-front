...
function GrazielaAgenda2024() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("GrazielaAgenda2023")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1Vs6yuu-Spi_ipqQbOSrcInLILQag03yLd75J86MTp28/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default GrazielaAgenda2024;
