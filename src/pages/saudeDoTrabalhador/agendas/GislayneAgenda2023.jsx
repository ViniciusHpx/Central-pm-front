...
function GislayneAgenda2023() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("GislayneAgenda2023")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1jjmZJMTE4-RmjTyK827jL-oO-AWqcaqKR1BqILm3GeQ/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default GislayneAgenda2023;
