...
function RelatorioVaptForm() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("RelatorioVaptForm")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/forms/d/e/1FAIpQLSeBMIHTooDV-cqzQ3dS4Lu1WzmYYblcHr3qJNDWOi9mmJusbg/viewform?usp=sharing"
                    ></iframe>
                </div>
            )}
        </div>
...
export default RelatorioVaptForm;
