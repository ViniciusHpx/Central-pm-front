...
function RdqaJudicializacao2023() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("RdqaJudicializacao2023")) {
                    navigate("/");
    ...
    return (
        <div>
            <SideNav activeLink={"judicializacao"} />
            {loading ? (
                <div>
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1MgNMoiXU9D3-8GnnO0PXuU0PXNH0nexu-3yEtFNuqfk/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default RdqaJudicializacao2023;
