...
function RelatorioDeFocosDengue() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("RelatorioDeFocosDengue")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://lookerstudio.google.com/embed/reporting/deba56f6-3f75-4683-871b-ef03abeee108/page/sf3JD/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default RelatorioDeFocosDengue;
