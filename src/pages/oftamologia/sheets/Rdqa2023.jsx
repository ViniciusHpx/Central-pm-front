...
function RdqaOftamologia2023() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("RdqaOftamologia2023")) {
                    navigate("/");
    ...
    return (
        <div>
            <SideNav activeLink={"Oftamologia"} />
            {loading ? (
                <div>
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1TJ2cdh4GAc1kd-Vbk4SkMgFJZGCDv4ijtXfMdcIvQCU/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default RdqaOftamologia2023;
