...
function NotificacaoDeAusenciaProfissional() {
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/forms/d/e/1FAIpQLSf-l0bljG2v7jfhLnlt_c9vsI-yvow2T7i7d_exJQ4AOTCzDQ/viewform?embedded=true"
                    ></iframe>
                </div>
            )}
        </div>
...
export default NotificacaoDeAusenciaProfissional;
