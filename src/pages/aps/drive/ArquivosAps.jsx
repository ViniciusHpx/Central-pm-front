...
function ArquivosAps() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("ArquivosAps")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://drive.google.com/embeddedfolderview?id=1YIo9JYb1KHCxqt2h_BGY5jWqz1P8x0Ky#list"
                    ></iframe>
                </div>
            )}
        </div>
