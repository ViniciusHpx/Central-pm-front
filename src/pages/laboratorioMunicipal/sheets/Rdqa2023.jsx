...
function RdqaLaboratorioMunicipal2023() {
    ...
    return (
        <div>
            <SideNav activeLink={"laboratoriomunicipal"} />
            {loading ? (
                <div>
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1ydxBiHj6Rii3Jv_rLuFtK--IC8xolex2pDvpDa9r8zA/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default RdqaLaboratorioMunicipal2023;
