...
function FormularioEncaminhamentoEntrelacos() {
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/forms/d/e/1FAIpQLSeOFGySUULQoHax4pS8P-uysPNM-_IgRPU8O1rMoRUG6bn5Ag/viewform"
                    ></iframe>
                </div>
            )}
        </div>
...
export default FormularioEncaminhamentoEntrelacos;
