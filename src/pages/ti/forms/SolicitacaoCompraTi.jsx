...
function SolicitacaoCompraTi() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("SolicitacaoCompraTi")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/forms/d/e/1FAIpQLSci8S64tmflD-4IJJSNvmMlhG7899_5h9Pqgp3rTipphsNUtg/viewform"
                    ></iframe>
                </div>
            )}
        </div>
...
export default SolicitacaoCompraTi;
