...
function EscalaSobreAvisoTi() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("EscalaSobreAvisoTi")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1LpQDOLIX2le51hv3rpVpsS1Bc_0RVwmIMf5moIbOhjQ/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default EscalaSobreAvisoTi;
