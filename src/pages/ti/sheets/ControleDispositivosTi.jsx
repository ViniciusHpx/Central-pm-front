...
function ControleDispositivosTi() {
    ...
    function verificaPermissao() {
        axios({
            ...
            .then((res) => {
                if (!res.data.permissoes.includes("ControleDispositivosTi")) {
                    navigate("/");
            ...
            {loading ? (
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 iframe">
                    <iframe
                        ...
                        src="https://docs.google.com/spreadsheets/d/1NOA-X9m6KKyzFOPfMqLvsdMwGwhkWEdougVnpX9OlrY/edit?rm=demo"
                    ></iframe>
                </div>
            )}
        </div>
...
export default ControleDispositivosTi;
